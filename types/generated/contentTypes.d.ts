...
export interface ApiJourneyJourney extends Schema.CollectionType {
  ...
  attributes: {
    ...
    milestones: Attribute.Relation<
      'api::journey.journey',
      'oneToMany',
      'api::journey-milestone.journey-milestone'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiJourneyMilestoneJourneyMilestone
  ...
  attributes: {
    ...
    stage: Attribute.String & Attribute.Required;
...
export interface ApiTruckTruck extends Schema.CollectionType {
  ...
  attributes: {
    plate: Attribute.String & Attribute.Unique;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::journey-milestone.journey-milestone': ApiJourneyMilestoneJourneyMilestone;
